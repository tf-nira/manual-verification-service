...
import in.tf.nira.manual.verification.constant.ProcessedLevelType;
import in.tf.nira.manual.verification.constant.PurposeType;
import in.tf.nira.manual.verification.constant.QualityType;
import in.tf.nira.manual.verification.util.DateAdapter;
import lombok.Data;
